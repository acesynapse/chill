...
class Chill {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Chill_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-chill-loader.php';

		/**
		 * Includes SnowPage activation file.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/snowpage-activation.php';
	 ...
	 *
	 * @since     1.0.0
	 * @return    Chill_Loader    Orchestrates the hooks of the plugin.
	 */
