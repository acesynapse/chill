	 ...
	 */
	 protected function register_controls() {
		 ...
		 protected function render() {
 			echo '<div><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/uikit/3.15.23/css/uikit.min.css"/> <script>const formatter=new Intl.NumberFormat("en-US",{style: "currency", currency: "USD", minimumFractionDigits: 2, maximumFractionDigits: 2,}); function voteCalc(){let homev=Number(document.getElementById("valueNumber").value); let homew=Number(homev / 1000); let equas=Number(document.getElementById("townSelect").value); let burd=homew * equas; document.getElementById("resultterms").innerText=formatter.format(burd);}</script> <div class="uk-card uk-card-default uk-card-body uk-border-rounded"> <span class="uk-text-lead">Library Vote Calculator</span> <form class="uk-form-horizontal"> <div class="uk-margin-small"> <label class="uk-form-label uk-text-uppercase">Property Value:</label> <div class="uk-form-controls"> <input class="uk-input" type="number" id="valueNumber" placeholder="$100,000"/> </div></div><div class="uk-margin-small"> <label class="uk-form-label uk-text-uppercase" for="town">Choose your town:</label> <div class="uk-form-controls"> <select class="uk-select" id="townSelect" name="town"> <option value="0.44">Chautauqua</option> <option value="0.45">Clymer</option> <option value="0.46">French Creek</option> <option value="0.46">Mina</option> <option value="0.57">North Harmony</option> <option value="0.48">Ripley</option> <option value="0.46">Sherman</option> <option value="0.66">Westfield</option> </select> </div></div><div class="uk-margin-small"> <input class="uk-button uk-button-primary uk-border-rounded" type="button" onClick="voteCalc()" Value="Calculate"/> </div><div class="uk-margin-small"> <label class="uk-form-label uk-text-uppercase">Your Library Support:</label> <div class="uk-form-controls"> <span class="uk-text-bold" id="resultterms">$0.00</span></div></div></form></div></div>';
 	 	}
